...
@WebServlet(name ="JuiceController", value = "/juice")
public class JuiceController extends HttpServlet {
...
*/
        ...
        int numOfProduct = productService.numOfProducts(currentPage, productsPerPage,7);
