...
@WebServlet(name ="SodaController", value = "/soda")
...
//        if (type==null) {
        productList = productService.getProductByPage(currentPage, productsPerPage,5);
/*
...
//        request.setAttribute("productList", productList);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("soda.jsp");
