...
@WebServlet(name ="YaourtController", value = "/yaourt")
public class YaourtController extends HttpServlet {
...
//        if (type==null) {
        productList = productService.getProductByPage(currentPage, productsPerPage,4);
/*
...
*/
        ...
        int numOfProduct = productService.numOfProducts(currentPage, productsPerPage,4);
...
//        request.setAttribute("productList", productList);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("yaourt.jsp");
