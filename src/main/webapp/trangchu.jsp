...
<section class="dv-home-sanpham" style="margin-top: -50px;">
    <div class="pagewrap">
        ...
        <div class="pro_home_id flex">
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp3.png"/></a></li>
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp4.png"/></a></li>
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp5.png"/></a></li>
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp6.png"/></a></li>
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp7.png"/></a></li>
            ...
            <ul>
                <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp8.png"/></a></li>
    ...
    <div class="pagewrap">
        <div class="home-left tin_right">
            <div class="box_right_pro_view">
                ...
                <ul>
                    <li class="vertical-menu vertical-menu-1"><a href="index.php?page=sanpham" title="">Trà truyền thống</a>
                        <i class="fa fa-plus-square-o" ></i>
                        <i class="fa fa-minus-square-o" ></i>
                        <ul class="vertical-menu-sub sub-3" style="display: none;">
                            <div class="col-mn-3">
                                <li><a href="index.php?page=sanpham" title="">Hồng trà</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà ô long</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà hoa nhài</a></li>
                            </div>
                            <div class="clr"></div>
                        </ul>
                    </li>
                    <li class="vertical-menu vertical-menu-2"><a href="index.php?page=sanpham" title="">Trà sữa trái cây</a>
                        <i class="fa fa-plus-square-o" ></i>
                        <i class="fa fa-minus-square-o" ></i>
                        <ul class="vertical-menu-sub sub-3" style="display: none;">
                            <div class="col-mn-3">
                                <li><a href="index.php?page=sanpham" title="">Trà xanh vị cam</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà ô mai đào</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà xanh vị ổi</a></li>
                            </div>
                            <div class="clr"></div>
                        </ul>
                    </li>
                    <li class="vertical-menu vertical-menu-3"><a href="index.php?page=sanpham" title="">Trà sữa Đài Loan</a>
                        <i class="fa fa-plus-square-o" ></i>
                        <i class="fa fa-minus-square-o" ></i>
                        <ul class="vertical-menu-sub sub-3" style="display: none;">
                            <div class="col-mn-3">
                                <li><a href="index.php?page=sanpham" title="">Hồng trà sữa</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà sữa mật ong</a></li>
                                <li><a href="index.php?page=sanpham" title="">Trà sữa hokaido</a></li>
                            </div>
                            <div class="clr"></div>
                        </ul>
                    </li>
            ...
            <div class="box_right_pro_view">
                ...
                <div class="marquee">
                    <div class="blog-item">
                        <div class="img-box">
                            <a href="index.php?page=sanpham_view" class="open-post">
                                <img class="img-fluid" src="delete/sanpham/sp1.png" alt="">
                            </a>
                        </div>
                        <div class="text-box">
                            <a href="index.php?page=sanpham_view" class="">
                    ...
                    <div class="blog-item">
                        <div class="img-box">
                            <a href="index.php?page=sanpham_view" class="open-post">
                                <img class="img-fluid" src="delete/sanpham/sp2.png" alt="">
                            </a>
                        </div>
                        <div class="text-box">
                            <a href="index.php?page=sanpham_view" class="">
                    ...
                    <div class="blog-item">
                        <div class="img-box">
                            <a href="index.php?page=sanpham_view" class="open-post">
                                <img class="img-fluid" src="delete/sanpham/sp3.png" alt="">
                            </a>
                        </div>
                        <div class="text-box">
                            <a href="index.php?page=sanpham_view" class="">
                    ...
                    <div class="blog-item">
                        <div class="img-box">
                            <a href="index.php?page=sanpham_view" class="open-post">
                                <img class="img-fluid" src="delete/sanpham/sp4.png" alt="">
                            </a>
                        </div>
                        <div class="text-box">
                            <a href="index.php?page=sanpham_view" class="">
            ...
            <div class="box_right_pro_view">
                <a href="#"><img src="delete/trangchu/4.png"></a>
            </div>
            <div class="box_right_pro_view">
        ...
        <div class="home-right">
                ...
                <div class="wrap_banner">
                    <div class="col-sm-6 img-left">
                        <a class="img1" href="#" title="Banner 1">
                            <img class="lazyload loaded" src="delete/trangchu/1.png" data-src="" alt="Banner 1" data-was-processed="true">
                        </a>
                        <a class="img1" href="#" title="Banner 1">
                            <img class="lazyload loaded" src="delete/trangchu/2.png" data-src="" alt="Banner 1" data-was-processed="true">
                        </a>
                    </div>
                    <div class="col-sm-6 img-right">
                        <a class="img1" href="#" title="Banner 2">
                            <img class="lazyload loaded" src="delete/trangchu/3.png" data-src="" alt="Banner 2" data-was-processed="true">
                        </a>
                    </div>
                </div>
                <div class="clr"></div>
            ...
            <section class="dv-home-sanpham">
                ...
                <div class="pro_home_id flex">
                    ...
                    <ul>
                        <li><a href="trasua_view.jsp"><img src="delete/sanpham/sp2.png"/></a></li>
                        <h3><a href="trasua_view.jsp">Okinawa Oreo Cream Milk Tea</a></h3>
                        <h4><span>65.000 <sup>₫</sup></span> 57.000 <sup>₫</sup></h4>
                        <span class="css-1h3p11h">-12%</span>
                        <p class="p-star">
                    ...
                    <ul>
                        <li><a href="index.jsp?page=trasua_view"><img src="delete/sanpham/sp5.png"/></a></li>
