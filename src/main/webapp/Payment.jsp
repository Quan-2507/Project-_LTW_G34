...
<div class="container p-0 mgt">
  ...
  <div class="row p-2 mt-3 bgcolor">
    ...
    <div class="col-lg-6 col-sm-6 mt-1 ">
      ...
      <span class="mt-3 d-block" id="address"><%=a.getAddress()%></span>
    </div>
            ...
            <form id="changeNam" onsubmit="return check()" method="post" action="ChangeInforInPayment">
              ...
              <table>
                ...
                <tr id="changeNgaySinh">
                  ...
                  <td>
                    <div id="InNS">
                      <input id="HienThiNS" name="HienThiNS" type="date" value="<%=a.getDateOfBirth()%>">
                    </div>
                  </td>
                </tr>
                <tr id="changeDC">
                ...
                <tr id="changeDCReceive">
                  ...
                  <td>
                    <div id="">
                      <input id="HienThiDCReice" name="DCNHHT" type="text" value="<%=a.getAddress()%>">
                    </div>
                  </td>
                </tr>
                <tr id="SubmitSB">
        ...
        <tr class="tr">
          ...
          <td class="w300">
            <div class="item d-flex justify-content-center">
              <div class="item_img">
                <img src="<%=url%>/Products/<%=(p.getImages().isEmpty())?"":p.getImages()%>"
