  ...
  <div class="row">
    <div class="col-lg-12 overflow-hidden">
      <table class="mb-3" id = "wattingConfirm">
        ...
        <%
          ArrayList<Orders> listInvoiceWaitting = (ArrayList<Orders>) request.getAttribute("listInvoiceWaitting");
          if (!listInvoiceWaitting.isEmpty() && listInvoiceWaitting != null)
          {
            int stt = 1;
            for (Orders i : listInvoiceWaitting) {
        %>
        <tr data-bs-toggle="modal" data-bs-target="#detailInvoice" onclick="detailInvoice(<%=i.getId()%>)">
          <td class="w40">
            <%=stt%>
          </td>
          <td>
          ...
          <td>
            <div class="d-flex w-100 justify-content-center">
              <button class="btnAdd bgcolor bd-full"  data-bs-toggle="modal" data-bs-target="#" onclick="cancelInvoice(<%=i.getId()%>)"><i class="fa fa-times text-color"  title="Huỷ đơn hàng" aria-hidden="true"></i></button>
            </div>
          </td>
        </tr>
        <%
      ...
      <table class="mb-3 d-none" id = "confirmed">
        ...
        <%
          ArrayList<Orders> listInvoiceConfirmed = (ArrayList<Orders>) request.getAttribute("listInvoiceConfirmed");
          if (!listInvoiceConfirmed.isEmpty() && listInvoiceConfirmed != null)
          {
            int stt = 1;
            for (Orders i : listInvoiceConfirmed) {
        %>
        <tr data-bs-toggle="modal" data-bs-target="#detailInvoice" onclick="detailInvoice(<%=i.getId()%>)">
          <td class="w40">
            <%=stt%>
          ...
          <td>
            <div class="d-flex w-100 justify-content-center">
              <button class="delete btnAdd bgcolor bd-full" data-bs-toggle="modal" data-bs-target="#" onclick="delInvoice('<%=i.getId()%>', 'confirm')"><i class="fa fa-trash-o text-color" title="Xóa" aria-hidden="true"></i></button>
            </div>
          </td>
        </tr>
        <%
      ...
      <table class="mb-3 d-none" id = "canceled">
        ...
        <%
          ArrayList<Orders> listInvoiceCanceled = (ArrayList<Orders>) request.getAttribute("listInvoiceCanceled");
          if (!listInvoiceCanceled.isEmpty() && listInvoiceCanceled != null)
          {
            int stt = 1;
            for (Orders i : listInvoiceCanceled) {
        %>
        <tr data-bs-toggle="modal" data-bs-target="#detailInvoice" onclick="detailInvoice(<%=i.getId()%>)">
          <td class="w40">
            <%=stt%>
          ...
          <td>
            <div class="d-flex w-100 justify-content-center">
              <button class="delete btnAdd bgcolor bd-full" data-bs-toggle="modal" data-bs-target="#" onclick="delInvoiceCancel('<%=i.getId()%>', 'cancel')"><i class="fa fa-trash-o text-color" title="Xóa" aria-hidden="true"></i></button>
            </div>
          </td>
        </tr>
        <%
